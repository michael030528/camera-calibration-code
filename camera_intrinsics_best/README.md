...
| `192.168.1.103` | `camera_intrinsics_192_168_1_103.yml` | 30 | `0.6996 px` | Good |
| `192.168.1.104` | Not available | - | - | Not calibrated yet |
| `192.168.1.105` | `camera_intrinsics_192_168_1_105.yml` | 30 | `0.8510 px` | Usable |
